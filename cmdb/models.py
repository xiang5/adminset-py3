...
class Idc(models.Model):
    ids = models.CharField(u"机房标识", max_length=100, unique=True)
    name = models.CharField(u"机房名称", max_length=100, unique=True)
    ...
    memo = models.TextField(u"备注信息", max_length=100, blank=True)
...
class Host(models.Model):
    ...
    ip = models.GenericIPAddressField(u"内网IP", max_length=15)
    other_ip = models.CharField(u"外网IP", max_length=15, blank=True)
#    other_ip = models.CharField(u"其他IP", max_length=15, blank=True)
    ...
    disk = models.CharField(u"硬盘信息", max_length=100, blank=True)
